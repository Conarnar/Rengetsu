	...
	if len(args) == 2:
		try:
			...
			if i > 0:
				...
				return f'**[Argument Error]** Arg 1 ({args[1]}) must be a positive integer'
		except ValueError:
			return f'**[Argument Error]** Arg 1 ({args[1]}) must be a positive integer'
	elif len(args) == 3:
		try:
			...
			return f'**[Argument Error]** Arg 1 ({args[1]}) must be an integer'
		try:
			i2 = int(args[2])
		except ValueError:
			return f'**[Argument Error]** Arg 2 ({args[2]}) must be an integer'
...
async def c_multiroll(line, message):
	...
	if len(args) == 3:
		try:
			...
			if i1 <= 0 or i1 >= 500:
				return f'**[Argument Error]** Arg 1 ({args[1]}) must be a positive integer less than 500'
		except ValueError:
			return f'**[Argument Error]** Arg 1 ({args[1]}) must be a positive integer less than 500'
		...
		try:
			...
			if i2 <= 0:
				return f'**[Argument Error]** Arg 2 ({args[2]}) must be a positive integer less than 500'
		except ValueError:
			return f'**[Argument Error]** Arg 2 ({args[2]}) must be a positive integer'
		...
		try:
			...
			if i1 <= 0 or i1 > 100:
				return f'**[Argument Error]** Arg 1 ({args[1]}) must be a positive integer 100 or less'
		except ValueError:
			return f'**[Argument Error]** Arg 1 ({args[1]}) must be a positive integer 100 or less'
		...
		try:
			...
			return f'**[Argument Error]** Arg 3 ({args[3]}) must be an integer'
...
async def c_multiroll_short(line, message):
	...
	try:
		...
		if i1 <= 0 or i1 > 100:
			return f'**[Argument Error]** Arg 1 ({i1}) must be a positive integer 100 or less'
